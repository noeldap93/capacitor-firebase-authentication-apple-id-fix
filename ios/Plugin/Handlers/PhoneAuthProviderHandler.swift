...
class PhoneAuthProviderHandler: NSObject {
    ...
    private func verifyPhoneNumber(_ call: CAPPluginCall, _ phoneNumber: String?) {
        ...
        PhoneAuthProvider.provider()
            .verifyPhoneNumber(phoneNumber, uiDelegate: nil) { verificationID, error in
                ...
                var result = FirebaseAuthenticationHelper.createSignInResult(credential: nil, user: nil, idToken: nil, nonce: nil, fullName: nil)
    ...
    private func handleVerificationCode(_ call: CAPPluginCall, _ verificationID: String?, _ verificationCode: String?) {
        ...
        self.pluginImplementation.handleSuccessfulSignIn(credential: credential, idToken: nil, nonce: nil, fullName: nil)
    }
}
